...
| **Tier 1 — Amendment records** | `*.md.amendments.jsonl` | ~10 files | merged at read time |
...
|---|---|---|
| Precedence invariant (Theorem 1) | N=1000 randomized clinical queries, notebook §8.3 | **1000/1000** (100%) amendment precedes canonical |
...
| 2026-05-16 | Stale `feedback_brain_pipeline_max_plan_only.md` confused agent twice in one session | Amendment sidecar (×2) on the original file | Theorem 1 lived demonstration |
...
- **No model-generated corrections** — amendments are operator-authored. Model self-critique (CRAG) is orthogonal and complementary.
