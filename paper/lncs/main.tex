...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/F1-consent-gesture.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.95\textwidth]{../figures/F2-supersession-view.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.95\textwidth]{../figures/F3-query-interface.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/F4-latency.png}
