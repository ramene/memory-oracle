...
% Sequence diagram showing supersession block precedes canonical body.
...
\node[superblock] (super) at (0,0) {%
  \textbf{\textcolor{orange!70!black}{\#\# Supersession Notice (1 record)}}\\[2pt]
  \textbf{Supersession 1 — 2024-03-15T14:22:00Z}\\
...
% --- Line number markers for supersession block ---
...
\node[font=\sffamily\scriptsize, gray!60!black, align=left, text width=14cm,
  ...
  {\textbf{Theorem 1 (Precedence Invariant).}
   Let $D$ be a canonical memory file with $k \geq 1$ supersession records
   ...
   containing a supersession assertion and every line $\ell_c$ containing a
...
clinical case. The retrieval engine emits supersession records (orange,
